function CardItem(props){
    return (
    <li className="w-60 h-64 col-span-1 flex flex-col text-center bg-gray-100 rounded-lg shadow divide-y divide-gray-200 m-2">
...
export default function CardList(props) {
    return (
        <ul className="flex-grow px-24 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
